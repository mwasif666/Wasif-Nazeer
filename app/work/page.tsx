                ...
                <div className="col-lg-8 mx-lg-auto">
                  <div className="text-center">
                    ...
                    <h3 className="ds-3 mt-3 mb-4 text-dark">
                      ...
                      <span className="text-300">Each Design</span>
                    </h3>
                    <p className="text-300 fs-5">
                      Explore my latest work and discover the craftsmanship
                      behind each design: <br />a detailed look into how I bring
              ...
              <div className="row">
                <div className="card-scroll mt-8">
                  <div className="cards">
                          ...
                          <div className="col-lg-6">
                            <div className="card__image-container zoom-img position-relative">
                              <img
                                ...
                                src="/assets/imgs/Gproject/vampire.png"
                          ...
                          <div className="col-lg-6">
                            <div className="card__content px-md-4 px-3">
                              <div className="card__title d-md-flex align-items-center mb-0 mb-lg-2">
                                <Link href="#" className="card_title_link">
                                  ...
                                  <h3 className="fw-semibold">
                                    VampireTools E-commerce Redesign
                                  </h3>
                                </Link>
                                <Link
                                  href="#"
                              ...
                              <p className="text-300 mb-lg-auto mb-md-4 mb-3">
                                Revolutionized the online shopping experience
                                with a complete UI/UX overhaul for VampireTools.
                                Implemented intuitive product discovery flows,
                                streamlined checkout process, and personalized
                                recommendations that increased conversion rates
                                by 42%. The design focuses on minimal aesthetics
                    ...
                    {/* Card 2 - App Design Project */}
                    <div className="card-custom" data-index={0}>
                      <div className="card__inner bg-6 p-lg-6 p-md-4 p-3">
                        <div className="card__image-container zoom-img position-relative">
                          <img
                            className="card__image"
                            src="/assets/imgs/work/img-2.png"
                            alt="Fitness App UI"
                          />
                          <Link
                            href="#"
                        ...
                        <div className="card__content px-md-4 px-3">
                          ...
                          <p className="text-300 mb-lg-auto mb-md-4 mb-3">
                            Designed a comprehensive fitness tracking app that
                            integrates workout planning, nutrition tracking, and
                            progress analytics. The clean interface features
                            customizable workout routines, real-time form
                            correction using AI, and social challenges.
                            Gamification elements increased user retention by
                            65% during beta testing.
                          </p>
                          <div className="d-md-flex content">
                            <p className="mb-0 fs-7 text-dark text-uppercase w-40">
                              Client
                        ...
                        <div className="row">
                          <div className="col-lg-6">
                            <div className="card__image-container zoom-img position-relative">
                              <img
                                className="card__image"
                                src="/assets/imgs/GProject/img-2.png"
                          ...
                          <div className="col-lg-6">
                            <div className="card__content px-md-4 px-3">
                              ...
                              <p className="text-300 mb-lg-auto mb-md-4 mb-3">
                                Developed a high-performance trading platform
                                with real-time market data visualization and
                                advanced charting tools. Built with React for
                                the frontend and Node.js for the backend, the
                                platform handles 10,000+ concurrent users with
                                sub-second latency. Features include portfolio
                                analytics, algorithmic trading integration, and
                              ...
                              <div className="d-md-flex content">
                                ...
                                <p className="mb-0 card__description text-300 fs-6 mb-0">
                                  React, Node.js, WebSocket, D3.js, PostgreSQL
                                </p>
                              </div>
                            </div>
                          </div>
                        ...
                        <div className="row">
                          <div className="col-lg-6">
                            <div className="card__image-container zoom-img position-relative">
                              <img
                                className="card__image"
                                src="/assets/imgs/work/img-background.png"
                                alt="Tourist App Design"
                              />
                              <Link
                                href="#"
                                className="card-image-overlay position-absolute start-0 end-0 w-100 h-100"
                          ...
                          <div className="col-lg-6">
                            <div className="card__content px-md-4 px-3">
                              ...
                              <p className="text-300 mb-lg-auto mb-md-4 mb-3">
                                Created a vibrant visual identity and UI for a
                                travel app that helps users discover hidden gems
                                and plan authentic local experiences. The design
                                system features custom illustrations,
                                interactive maps with AR previews, and a
                                mood-based recommendation engine. The playful
                                yet functional aesthetic increased user
                                engagement by 78%.
                              </p>
                              <div className="d-md-flex content">
                                <p className="mb-0 fs-7 text-dark text-uppercase w-40">
                              ...
                              <div className="d-md-flex content">
                                ...
                                <p className="mb-0 card__description text-300 fs-6 mb-0">
                                  Illustrator, Procreate, After Effects, Figma
                                </p>
                              </div>
                            </div>
                          </div>
